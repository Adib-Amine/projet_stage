            ...
            <table class="table table-striped table-hover table-white">
                ...
                <tbody>
                    <tr v-for="devoir in this.info.data" :key="devoir.id">
                        ...
                        <td>
                            <a v-on:click="showModelUpdate(devoir.id)" class="settings" ><i class="material-icons">&#xE8B8;</i></a>
...
export default {
    ...
    methods:{
        ...
        // async fetchDevoir(id){
        //     const res = await  axios.get("http://localhost:8000/devoirs/"+id)
        //     return res 
        // },
        coonfirmDelet(id){
        ...
        showModel(){
            this.$refs.addDevoirModel.show();
            this.getTotalEntries()
        },
        async showModelUpdate(id){
            const res = await this.fetchDevoir(id)
